...
VALID_SERVER = ['cn']
MODULE_FOLDER = './submodule/AlasAaaBridge/module'
...
class ImageExtractor:
    ...
    def get_file(self, genre='', server='cn'):
        for ext in ['.png', '.gif']:
            ...
            file = os.path.join('./submodule/AlasAaaBridge/assets', server, self.module, file).replace('\\', '/')
...
class ModuleExtractor:
    def __init__(self, name):
        self.name = name
        self.folder = os.path.join('./submodule/AlasAaaBridge/assets', 'cn', name)
...
class AssetExtractor:
    ...
    def __init__(self):
        ...
        modules = [m for m in os.listdir('./submodule/AlasAaaBridge/assets' + '/cn')
                   if os.path.isdir(os.path.join('./submodule/AlasAaaBridge/assets' + '/cn', m))]
